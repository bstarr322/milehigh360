...
'      <h3>2024 Tee It Up For College Golf Tournament Registration</h3>' + 
'      <div class="field radio 15539200 required" >' + 
'<label for="15539200"><input id="15539200" name="registration-type" class="required" type="radio" value="250.000000" maxlength="255" data-short-name="Golfer Registration" data-ticket-quantity="1" data-registration-type-value="15535105" data-non-deductible-amount="185.000000"></input><span class="label">$250.00 - Golfer Registration: Registration Fee for Single Golfer</span></label>' + 
'</div>' + 
...
'<label for="123648000"><input id="123648000" name="registration-type" class="required" type="radio" value="2500.000000" maxlength="255" data-short-name="Scholarship Champion" data-ticket-quantity="4" data-registration-type-value="123645953" data-non-deductible-amount="1240.000000"></input><span class="label">$2,500.00 - Scholarship Champion: Scholarship Champion</span></label>' + 
'</div>' + 
...
'' +  '';var successHtml15536128 = '<div class=\'donation-success\'>' +
                                                 '  <h2>Thank You for Your Tee It Up for College Registration!</h2>' +
              ...
              if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                  ...
                  Bloomerang.Util.IsPayPalVenmoEnabled = false;
                       jQuery("#paypal-button-container").remove();Bloomerang.Util.IsPayPalVenmoEnabled = false;
