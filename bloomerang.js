var insertForm116310016 = function() {
        var html116310016 = '<style text=\'text/css\'>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha116310016"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml116310016 = '<div class=\'donation-success\'>' +
                                                       ...
                                                       '  <p>Your support makes an impact in the lives of many students in their journey through education and life. Thank you for your generosity!</p>' + 
                                                        ...
                                                        '</div>';( function($) {if (!Bloomerang.useDonationId('116310016')) { 
                                    html116310016 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                                }if (jQuery('#bloomerangForm116310016').length) {
                        
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html116310016 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm116310016').after(html116310016);
...
jQuery("#donation-form .section.payment h3").remove();
                       ...
                       window.captchaLoadCallback = function() {
                        ...
                        Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                            ...
                            function() {
                                ...
                                jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha116310016', { 'sitekey' : '6Ld-5ZYUAAAAAK4cgvOSZG6_B_wLwd3j6Jt_G3nf' }));
                            },
                            true,
                            true);
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml116310016);
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidation(function() { insertForm116310016(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidation(function() { insertForm116310016(); })});
                    }
